...
SECRET_KEY = 'django-insecure-##aby@+@z03j*3a^kth+lq!-0p1z!s+*vi^_!e+b0c!rjigst8'
...
ROOT_URLCONF = 'digitalsuperhighway.urls'
...
WSGI_APPLICATION = 'digitalsuperhighway.wsgi.application'
   ...
   # 'default': {
    ...
    # },
     'default': {
        ...
        'PORT': 27110,
        'PASSWORD': 'E35H--HfhbDh3c6abbG2d4Bed3bF5B2d'
    }
}
